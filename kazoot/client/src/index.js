...
import { Home, BrowseQuizzes, NewQuiz, EditQuiz, ListQuizes } from './kazoot-components'
  ...
  render() {
    return (
      <NavBar brand="Kazoot">
        ...
        <NavBar.Link to="/listQuizes">Kviss</NavBar.Link>
      </NavBar>
    );
  }
}
...
ReactDOM.render(
  ...
  <HashRouter>
    <div>
      ...
      <Route exect path="/listQuizes" component={ListQuizes}></Route>
      </ div>
    </HashRouter>,
  root
);
