      ...
      return Promise.resolve([
        {
          id: 1,
          title: 'Hva er tall??',
          description: 'Vi omgås tall. Hva er tall?',
          categoryId: 2,
        },
        {
          id: 2,
          title: 'Matte #1',
          description: 'Sjekk kunnskapen din i grunnleggende matte!',
          categoryId: 1,
        },
      ]);
    }
      ...
      return Promise.resolve([
        {
          id: 6,
          quizId: 1,
          question: 'Hva er tall??',
          answ0: 'Vi omgås tall. Hva er tall?',
          answ1: 'Vi omgås tall. Hva er tall?',
          answ2: 'Vi omgås tall. Hva er tall?',
          answ3: 'Vi omgås tall. Hva er tall?',
          numCorrect: 2,
        },
        {
          id: 2,
