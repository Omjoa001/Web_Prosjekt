...
const testQuestions: QuestionType[] = [
  ...
  },
  {
    id: 2,
    quizId: 1,
    question: 'hvilken dag er det i dag?',
    answ0: 'Tirsdag',
    answ1: 'Mandag',
    answ2: 'Onsadag',
    answ3: 'Ingen av de andre alternativene',
    numCorrect: 1,
  },
  {
    id: 3,
...
describe('Create questions ', () => {
  test('Create new question (200 Created)', (done) => {
    axios
      .post<{}, number>('/questions', {
        quizId: 2,
        question: 'Hva er 10*2?',
        answ0: '20',
        answ1: '10',
        answ2: '15',
        answ3: '4 ',
